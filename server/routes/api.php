...
use App\Http\Controllers\ProductionBranchController;
...
Route::middleware('auth:sanctum')->middleware('isadmin')->resource('production_branch', ProductionBranchController::class);
